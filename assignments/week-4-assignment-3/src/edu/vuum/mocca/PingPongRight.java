...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         * two data members.
         */
        private SimpleSemaphore mSemaphores[];
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            mSound = stringToPrint;
            mSemaphores = new SimpleSemaphore[] {
        ...
        private void acquire() {
            SimpleSemaphore thisSem = mSemaphores[FIRST_SEMA];
            thisSem.acquireUninterruptibly();
        }
        ...
        private void release() {
        	SimpleSemaphore thatSem = mSemaphores[SECOND_SEMA];
        	thatSem.release();
        }
    }
    ...
    public static void process(String startString, 
        ...
        // DONE - You fill in here, make pingSema start out unlocked.
        SimpleSemaphore pingSema = new SimpleSemaphore(1, true);
        // DONE - You fill in here, make pongSema start out locked.
