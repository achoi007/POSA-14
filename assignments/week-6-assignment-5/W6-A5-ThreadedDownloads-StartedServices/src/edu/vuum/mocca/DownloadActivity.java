...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	final String pathname = msg.getData().getString(DownloadUtils.PATHNAME_KEY);
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	downloadInt = DownloadIntentService.makeIntent(this, handler, url);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	downloadInt = ThreadPoolDownloadService.makeIntent(this, handler, url);
            which = "Starting ThreadPoolDownloadService";
            break;
        }
    	
    	if (downloadInt != null) {
			startService(downloadInt);
		}
